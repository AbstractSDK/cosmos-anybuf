use anybuf::Anybuf;
use crate::{coin::Coin, bank::Metadata, StargateMsg};
...
impl MsgMint {
    pub fn new(sender: impl Into<String>, amount: Coin, mint_to_address: impl Into<String>) -> Self {
        Self {
            sender: sender.into(),
            amount,
...
pub struct MsgBurn {
    pub sender: String,
    pub amount: Coin, // Assuming Anybuf is used for cosmos.base.v1beta1.Coin
    pub burn_from_address: String,
}

impl MsgBurn {
    pub fn new(sender: impl Into<String>, amount: Coin, burn_from_address: impl Into<String>) -> Self {
        Self {
            sender: sender.into(),
            amount,
...
impl MsgChangeAdmin {
    pub fn new(sender: impl Into<String>, denom: impl Into<String>, new_admin: impl Into<String>) -> Self {
        Self {
            sender: sender.into(),
            denom: denom.into(),
...
impl MsgSetBeforeSendHook {
    pub fn new(sender: impl Into<String>, denom: impl Into<String>, cosmwasm_address: impl Into<String>) -> Self {
        Self {
            sender: sender.into(),
            denom: denom.into(),
...
impl MsgForceTransfer {
    pub fn new(sender: impl Into<String>, amount: Coin, transfer_from_address: impl Into<String>, transfer_to_address: impl Into<String>) -> Self {
        Self {
            sender: sender.into(),
            amount,
